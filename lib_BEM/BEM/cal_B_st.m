function [TRAC2]=cal_B_st(face1,face2,w,lamda,mu,rho,Q,nint,nxi)
...
%% Overall integral and constructing matrix
    ...
    for j=1:ngd1
        ...
        ys=ps(2);
        zs=ps(3);
        ST0=B_tri_int_vec(vp,w,xia,yia,zia,wia,xs,ys,zs,area,STs(j),j);
        TRAC2(j,:)=ST0;
    end
else
   TRAC2=zeros(ngd1,ngd2);
    for j=1:ngd1
        ...
        ys=ps(2);
        zs=ps(3);
        ST0=B_tri_int_vec_diflay(vp,w,xia,yia,zia,wia,xs,ys,zs,area);
        TRAC2(j,:)=ST0;
    end 
